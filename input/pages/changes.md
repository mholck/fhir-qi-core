...
1. Changed recorded to modifierExtension in profiles to make it link correctly ([FHIR-48260](https://jira.hl7.org/browse/FHIR-48260)) Applied ([here](StructureDefinition-qicore-procedure.html)) and ([here](StructureDefinition-qicore-procedurenotdone.html)) and ([here](StructureDefinition-qicore-medicationadministration.html)) and ([here](StructureDefinition-qicore-medicationadministrationnotdone.html))
